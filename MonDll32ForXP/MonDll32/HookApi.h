...
typedef HANDLE (WINAPI *ptrCreateFileMapping) (
  HANDLE hFile,
  LPSECURITY_ATTRIBUTES lpFileMappingAttributes,
  DWORD flProtect,
  DWORD dwMaximumSizeHigh,
...
typedef HANDLE (WINAPI *ptrOpenFileMapping)(_In_ DWORD dwDesiredAccess, _In_ BOOL bInheritHandle, _In_ LPCWSTR lpName );
...
typedef HWND (WINAPI *ptrFindWindowEx)(
  _In_opt_ HWND    hwndParent,
  _In_opt_ HWND    hwndChildAfter,
  _In_opt_ LPCWSTR lpszClass,
  _In_opt_ LPCWSTR lpszWindow
...
typedef HMODULE (WINAPI *ptrLoadLibraryEx)(
  _In_       LPCWSTR lpLibFileName,
  _Reserved_ HANDLE  hFile,
  _In_       DWORD   dwFlags
);
...
typedef LONG (WINAPI *ptrRegOpenKeyEx)(
  _In_     HKEY    hKey,
  _In_opt_ LPCWSTR lpSubKey,
  _In_     DWORD   ulOptions,
  _In_     REGSAM  samDesired,
...
typedef LONG (WINAPI *ptrRegRestoreKey)(
  _In_ HKEY    hKey,
  _In_ LPCWSTR lpFile,
  _In_ DWORD   dwFlags
);
...
typedef LONG (WINAPI *ptrRegReplaceKey)(
  _In_     HKEY    hKey,
  _In_opt_ LPCWSTR lpSubKey,
  _In_     LPCWSTR lpNewFile,
  _In_     LPCWSTR lpOldFile
...
typedef LONG (WINAPI *ptrRegLoadKey)(
  _In_     HKEY    hKey,
  _In_opt_ LPCWSTR lpSubKey,
  _In_     LPCWSTR lpFile
);
...
BOOL WINAPI MyHttpSendRequestEx(
  _In_  HINTERNET          hRequest,
...
typedef BOOL (WINAPI *ptrHttpSendRequestEx)(
  _In_  HINTERNET          hRequest,
  _In_  LPINTERNET_BUFFERS lpBuffersIn,
  _Out_ LPINTERNET_BUFFERS lpBuffersOut,
  _In_  DWORD              dwFlags,
...
extern  ptrCreateFileMapping realCreateFileMapping;
extern  ptrOpenFileMapping realOpenFileMapping;
extern  ptrCryptAcquireContext realCryptAcquireContext ;
extern  ptrDeviceIoControl realDeviceIoControl;
extern ptrFindWindowEx realFindWindowEx;
...
extern	  ptrLoadLibraryEx realLoadLibraryEx;
...
extern	  ptrTerminateProcess realTerminateProcess;
	//注册表
extern	  ptrRegOpenKeyEx realRegOpenKeyEx;
...
extern	  ptrRegRestoreKey realRegRestoreKey;
extern	  ptrRegReplaceKey realRegReplaceKey;
extern	  ptrRegLoadKey realRegLoadKey;
...
extern	  ptrHttpSendRequest realHttpSendRequest;
extern	  ptrHttpSendRequestEx realHttpSendRequestEx;
extern	  ptrHttpOpenRequestW realHttpOpenRequestW;
extern	  ptrInternetConnect realInternetConnect;
...
extern  char filehandlepath[512];
...
//根据文件句柄获取文件名，MSDN推荐https://msdn.microsoft.com/en-us/library/aa366789(VS.85).aspx
