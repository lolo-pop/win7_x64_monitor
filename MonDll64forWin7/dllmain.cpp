...
{  
	...
	if (dirPos != -1)
	{
		...
		//OutputDebugString(L"hahaha3\n");
		for(TiXmlElement* elem = root->FirstChildElement(); elem != NULL; elem = elem->NextSiblingElement())
		{
			//OutputDebugString(L"hahaha4\n");
			//过滤几个与自己系统相关的程序
			//////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	{
		LhInstallHook(realRegDeleteValueA,MyRegQueryValueA,NULL,hHookRegDeleteValueA);
...
{  
	...
	case DLL_PROCESS_ATTACH:  
		...
		//	cout<<dlldir<<endl;
			...
			sprintf_s(g_log_path,"%sLog.txt",dlldir);//获取日志路径
