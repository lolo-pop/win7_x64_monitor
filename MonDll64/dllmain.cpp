	...
	*/
	...
	if (api[49]==1&&realResumeThread!=NULL)
	{
		...
		/*if(FAILED(result))
		{
			...
			OutputDebugStringA("install 64 hook resumethread fail");
		}*/
	...
	if (api[51]==1&&realSuspendThread!=NULL)
	{
		...
		if(FAILED(result))
		{
			...
			OutputDebugStringA("install 64 hook suspendthread fail");
		}*/
	...
	if (api[81]==1&&realTerminateThread!=NULL)
	{
		...
		if(FAILED(result))
		{
			...
			OutputDebugStringA("install 64 hook terminatethread fail");
		}*/
	...
	if (api[82]==1&&realVirtualFree!=NULL)
	{
		...
		if(FAILED(result))
		{
			...
			OutputDebugStringA("install 64 hook virtualfree fail");
		}
		*/
...
{  
	...
	case DLL_PROCESS_ATTACH:  
		{  
			...
			sprintf(log_path,"%sLog.txt",dlldir);//获取日志路径
			//cout<<log_path<<endl;
